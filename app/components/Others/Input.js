  ...
  render() {
    return (
      <div className="inputDiv" id={this.props.divId ? this.props.divId : ""} style={this.props.divStyle}>
        ...
        <input id={this.props.inputId ? this.props.inputId : ""} className={this.props.inputClassName ? this.props.inputClassName : "inputCustom"} type={this.props.type} value={this.props.value} onChange={this.props.handleChange} style={this.props.inputStyle}></input>
      </div>
    );
  }
}
