...
export const addNewMessage = (val) => {
	return{
		type: NEW_MESSAGE,
		payload: {id: val.id, message: val.message}
	}
};
...
export const setShowinChatList = (val) => {
	return{
		type: SHOWING_CHAT_LIST,
		payload: val
	}
};
